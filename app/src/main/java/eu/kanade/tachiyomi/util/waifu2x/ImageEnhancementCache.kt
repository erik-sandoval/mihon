...
object ImageEnhancementCache {
    ...
    fun getConfigHash(
        ...
        return "${noise}x${effectiveScale}_m${model}_rs${realEsrganStyle}_w${maxWidth}_h${maxHeight}_sw${skipMaxWidth}_sh${skipMaxHeight}_t${tileSize}_p${resolvedPrecision}_fa${if (fp16Arithmetic) 1 else 0}_b${resolvedBackend}_pv$ENHANCEMENT_PIPELINE_VERSION$modelRevision"
    }
